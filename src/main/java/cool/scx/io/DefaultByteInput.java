...
public final class DefaultByteInput implements ByteInput {
    ...
    ///
    /// @return 调用了几次底层拉取
    private long ensureAvailable() throws NoMoreDataException, ScxIOException {
        var pullCount = 0L;
     ...
     * @throws X X
     */
    private <X extends Throwable> void read0(ByteConsumer<X> consumer, long maxLength, boolean movePointer, long maxPullCount, boolean throwOnEOF) throws NoMoreDataException, ScxIOException, X, ScxWrappedException {
        ...
        while (remaining > 0) {
            ...
            try {
                ...
                if (e instanceof ScxIOException || e instanceof AlreadyClosedException || e instanceof NoMoreDataException || e instanceof NoMatchFoundException) {
                    // 为了防止 consumer 中的部分异常异常和 read0 中的本身的异常所混淆, 此处对其进行包装
    ...
    @Override
    public byte read() throws NoMoreDataException, ScxIOException, AlreadyClosedException {
        ensureOpen();// 确保 open
    ...
    @Override
    public <X extends Throwable> void read(ByteConsumer<X> byteConsumer, long maxLength) throws NoMoreDataException, ScxIOException, AlreadyClosedException, X, ScxWrappedException {
        ensureOpen();// 确保 open
    ...
    @Override
    public <X extends Throwable> void readUpTo(ByteConsumer<X> byteConsumer, long length) throws NoMoreDataException, ScxIOException, AlreadyClosedException, X, ScxWrappedException {
        ensureOpen();// 确保 open
    ...
    @Override
    public <X extends Throwable> void readFully(ByteConsumer<X> byteConsumer, long length) throws NoMoreDataException, ScxIOException, AlreadyClosedException, X, ScxWrappedException {
        ensureOpen();// 确保 open
    ...
    @Override
    public byte peek() throws NoMoreDataException, ScxIOException, AlreadyClosedException {
        ensureOpen();// 确保 open
    ...
    @Override
    public <X extends Throwable> void peek(ByteConsumer<X> byteConsumer, long maxLength) throws NoMoreDataException, ScxIOException, AlreadyClosedException, X, ScxWrappedException {
        ensureOpen();// 确保 open
    ...
    @Override
    public <X extends Throwable> void peekUpTo(ByteConsumer<X> byteConsumer, long length) throws NoMoreDataException, ScxIOException, AlreadyClosedException, X, ScxWrappedException {
        ensureOpen();// 确保 open
    ...
    @Override
    public <X extends Throwable> void peekFully(ByteConsumer<X> byteConsumer, long length) throws NoMoreDataException, ScxIOException, AlreadyClosedException, X, ScxWrappedException {
        ensureOpen();// 确保 open
    ...
    @Override
    public ByteMatchResult indexOf(ByteIndexer indexer, long maxLength) throws NoMatchFoundException, NoMoreDataException, ScxIOException, AlreadyClosedException {
        ensureOpen();// 确保 open
