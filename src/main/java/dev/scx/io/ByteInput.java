...
///
/// - 注意 : 支持传入 byteConsumer 的方法 (如 read, peek) 中. 如果 byteConsumer 本身发生了异常 则会被包装为 [dev.scx.exception.ScxWrappedException] 并抛出.
///
/// @author scx567888
public interface ByteInput extends AutoCloseable {
    ...
    void close() throws ScxInputException;
